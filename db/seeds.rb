...
Product.destroy_all
Product.create!(
  category_id: 18, image_url: 'http://res.cloudinary.com/priyag88/image/upload/c_scale,h_400/v1512427041/_102134885_otwlsm.jpg',
  title: 'NMD XR1',
  price: 150)
Product.create!(
  category_id: 18,
...
Product.create!(
  category_id: 19,
  image_url: 'http://res.cloudinary.com/priyag88/image/upload/v1512455650/_101015364_vtdttm.jpg',
  title: 'Boucle Jacket',
  price: 228)
